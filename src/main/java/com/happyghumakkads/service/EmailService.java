...
public class EmailService {
    ...
    public EmailService(
            ...
            @Value("${spring.sendgrid.from-email:${SENDGRID_FROM_EMAIL:amanshukla7876@gmail.com}}") String fromEmail,
            @Value("${spring.sendgrid.from-name:${SENDGRID_FROM_NAME:Aman Shukla}}") String fromName,
            Environment env) {
    ...
    public void sendContactMessage(String name, String email, String phone, String travelType, String body) throws IOException {
        String to = env.getProperty("brand.email", "amanshukla7876@gmail.com");
